...
echo form_input('txtMarque','',array('pattern' =>'[a-zA-Z1-9 ]*','required'=>'required', 'title'=>'Saisir des chiffres et lettres uniquement')).'<BR>';
...
echo form_input('txtDate','',array('pattern' =>'[0-9][0-9][/][0-9][0-9][/][0-9][0-9][0-9][0-9]','required'=>'required', 'title'=>'Saisir JJ/MM/AAAA')).'<BR>';
